let confirm_sound, cancel_sound, button_sound, help_sound, wrong_sound, insert_sound, cell_sound, success_sound, alert_sound;
let currentSound;
...
table.addEventListener('click', function (event) {
    ...
    if (targetCell.tagName !== 'TD' || targetCell.classList.contains('fixed'))
        return;
...
function saveToHistory(cell) {
    ...
    // Text1Text2를 가져온다.
    const directTextContents = [...cell.childNodes] // 배열의 메서드 사용을 위해 ... 스프레드 연산자를 사용하여 배열로 반환.
